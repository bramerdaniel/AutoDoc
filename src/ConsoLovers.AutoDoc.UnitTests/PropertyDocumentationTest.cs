...
{
   using ConsoLovers.AutoDoc.UnitTests.Setups;
   using ConsoLovers.AutoDoc.UnitTests.TestTypes;
   ...
   public class XmlDocumentationSourceTest
   {
      ...
      public void EnsureSummaryOfAPropertyWithSeeReferenceIsReturnedCorrectly()
      {
         ...
         summary.GetRawText().Should().Be("Gets or sets the <see cref=\"T:ConsoLovers.AutoDoc.UnitTests.TestTypes.ClassWithAll\" />");
      }
      ...
      public void EnsureSummaryOfAMethodWithSeeElementsIsReturnedCorrectly()
      {
         ...
         summary.GetRawText().Should().Be("Gets the <see cref=\"T:ConsoLovers.AutoDoc.UnitTests.TestTypes.ClassWithAll\" /> by the id.");
      }
      ...
      public void EnsureReturnsElementOfAMethodWithSeeElementsIsReturnedCorrectly()
      {
         ...
         summary.GetRawText().Should().Be("The result <see cref=\"T:ConsoLovers.AutoDoc.UnitTests.TestTypes.ClassWithAll\" /> when found.");
      }
